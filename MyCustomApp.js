...
function getAccessToken() {
    ...
    query+='client_id='+'3MVG9riCAn8HHkYUvpxb2KieHak3WbYV1mLuu7Ye6m6ztSWhcuJfOssAGrfy9anoOzbutLarfaiEc.U09zO8S';
    query+='&client_secret='+'5B312EC1EC9524C082BF5CA34F750B3C39B447BAD3B1A09F14149DA5D7999BED';
    query+='&code='+this.authCode;
    query+='&redirect_uri='+'https://anandhk47.github.io/Add-Salesforce-Contact/MyCustomApp.html';
    const init = {
        method: 'POST',
        mode: 'no-cors',
        credentials: 'include'
    ...
    fetch('https://login.salesforce.com/services/oauth2/token?'+query, init)
    .then(response => response.json())
    .then(data => document.getElementsByTagName('p')[1].innerHTML = JSON.stringify(data)  )
